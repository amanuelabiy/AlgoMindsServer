...
export const verifyEmailTemplate = (
  ...
  subject: "Confirm your AlgoMinds account",
  ...
  html: `
      <html><head><style>
        ...
        <div class="container">
          <div class="header">AlgoMinds</div>
          <div class="content">
...
export const passwordResetTemplate = (
  ...
  text: `To reset your password, please use the following verification code: ${code}`,
  html: `
      <html><head><style>
        body, html { margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4; color: #333333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); }
        ...
        .content h1 { font-size: 24px; color: #333333; }
        .content p { font-size: 16px; color: #666666; margin: 10px 0 20px; }
        .code { display: inline-block; padding: 15px 25px; font-size: 24px; font-weight: bold; background-color: ${brandColor}; color: #fff !important; border-radius: 5px; text-decoration: none; margin-top: 20px; }
        .footer { font-size: 14px; color: #999999; text-align: center; padding: 20px; }
      </style></head><body>
        <div class="container">
          <div class="header">AlgoMinds</div>
...
export const waitListTemplate = (
  ...
  subject: "Welcome to AlgoMinds",
  text: `Thank you for joining the AlgoMinds waitlist! Click the following link to learn more: ${url}`,
  html: `
      <html><head><style>
        body, html { margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4; color: #333333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Thank you for joining the AlgoMinds waitlist. We are excited to have you on board. Click the button below to learn more about what we have in store for you.</p>
